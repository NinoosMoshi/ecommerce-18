package com.ninos.shared.authentication.infrastructure.primary;
...
public class KindeJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<? extends GrantedAuthority> extractResourceRoles(Jwt jwt) {
        return com.ninos.shared.authentication.application.AuthenticatedUser.extractRolesFromToken(jwt).stream()
